...
def click_buy_moisturizers_button(browser):
    # This function clicks over the "Buy moisturizers" Button By scraping the page.

    browser.find_element_by_xpath("//button[text() = 'Buy moisturizers']").click()


def parse_aloe(browser):
    # This function finds all the aloe items on the page and returns the cost of all items in a list.
...
def parse_almond(browser):
    # This function finds all the almond items on the page and returns the cost of all items in a list.
...
def add_aloe(browser):
    # This function will add the minimum cost aloe item into the cart.
...
def add_almond(browser):
    # This function will add the minimum cost almond item into the cart.
